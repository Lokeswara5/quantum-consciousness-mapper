...
class WarningPatternAnalyzer:
    ...
    def analyze_critical_indicators(self, data):
        ...
        rolling_data = pd.Series(data).rolling(window=self.rolling_window)
    ...
    def plot_warning_analysis(self, window_data, drop_num):
        ...
        for col in indicators.columns:
            ...
            ax2.plot(time_to_drop[self.rolling_window-1:],
        ...
        scatter = ax3.scatter(stability[:-1], stability[1:],
                            c=range(len(stability)-1),
                            cmap='viridis')
        ...
        if len(freq_analysis['peak_freqs']) > 0:
        ...
        if len(transitions['transition_points']) > 0:
        ...
        ax6.plot(time_to_drop[self.rolling_window-1:],
                warning_score, 'r-')
